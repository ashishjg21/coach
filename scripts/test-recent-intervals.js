...
async function main() {
  ...
  activities.forEach((activity, idx) => {
    ...
    console.log(`   Duration: ${activity.moving_time ? Math.round(activity.moving_time / 60) : 'N/A'} min`)
    console.log(`   Distance: ${activity.distance ? (activity.distance / 1000).toFixed(2) : 'N/A'} km`)
  })
  ...
  workoutResult.rows.forEach((workout, idx) => {
    ...
    console.log(`   Duration: ${workout.durationSec ? Math.round(workout.durationSec / 60) : 'N/A'} min`)
  })
