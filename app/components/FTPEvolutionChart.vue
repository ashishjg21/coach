      ...
      <div v-else class="space-y-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/30 rounded-lg p-4 shadow">
            <div class="text-xs text-blue-600 dark:text-blue-400 font-semibold mb-1">Current FTP</div>
            <div class="text-2xl font-bold text-blue-900 dark:text-blue-100">{{ ftpData.summary.currentFTP || '-' }}</div>
          ...
          <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/30 rounded-lg p-4 shadow">
            <div class="text-xs text-green-600 dark:text-green-400 font-semibold mb-1">Peak FTP</div>
            <div class="text-2xl font-bold text-green-900 dark:text-green-100">{{ ftpData.summary.peakFTP || '-' }}</div>
          ...
          <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/30 rounded-lg p-4 shadow">
            <div class="text-xs text-purple-600 dark:text-purple-400 font-semibold mb-1">Starting FTP</div>
            <div class="text-2xl font-bold text-purple-900 dark:text-purple-100">{{ ftpData.summary.startingFTP || '-' }}</div>
            <div class="text-xs text-purple-700 dark:text-purple-300 mt-1">watts</div>
          </div>

          <div :class="getImprovementClass(ftpData.summary.improvement)" class="rounded-lg p-4 shadow">
            <div class="text-xs font-semibold mb-1">Improvement</div>
            <div class="text-2xl font-bold">
              {{ ftpData.summary.improvement !== null ? (ftpData.summary.improvement > 0 ? '+' : '') + ftpData.summary.improvement + '%' : '-' }}
            </div>
        ...
        <div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
          ...
          <ul class="text-xs text-blue-800 dark:text-blue-200 space-y-1">
            <li><strong>Training Zones:</strong> FTP is used to calculate personalized training zones</li>
            <li><strong>Progress Tracking:</strong> Monitor improvements in your aerobic fitness over time</li>
            <li><strong>Testing:</strong> Typically measured with a 20-minute test (95% of 20min power)</li>
          </ul>
        </div>
      </div>
    </div>
